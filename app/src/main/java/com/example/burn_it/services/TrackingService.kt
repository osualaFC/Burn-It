...
import com.example.burn_it.utils.Constants.FASTEST_LOCATION_INTERVAL
import com.example.burn_it.utils.Constants.LOCATION_UPDATE_INTERVAL
...
class TrackingService :LifecycleService() /**cos i need to observe from life data object*/{
    ...
    private fun updateNotificationTrackingState(isTracking: Boolean) {
        ...
        /***remove old actions and update notification with new actions**/
